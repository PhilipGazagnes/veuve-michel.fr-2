...
const rootComponents = [
  ...
  },
  {
    ...
    schema: {
      ...
      chai_sec: section('Le chai à barriques'),
      chai_eyebrow: { type: 'text', display_name: 'Chai — kicker' },
      chai_heading: { type: 'text', display_name: 'Chai — titre' },
      chai_body: { type: 'textarea', display_name: 'Chai — texte (paragraphes séparés par une ligne vide)' },
      chai_image: { type: 'asset', display_name: 'Chai — image', filetypes: ['images'] },
      chai_caption: { type: 'text', display_name: 'Chai — légende photo' },
      seo_sec: section('SEO'),
      seo_title: { type: 'text', display_name: 'Titre SEO' },
      seo_description: { type: 'textarea', display_name: 'Description SEO' },
    },
...
async function seedContent() {
  ...
  await upsertStory({
    ...
    content: {
      ...
      order_to: '/contact',
      chai_eyebrow: 'Le chai',
      chai_heading: 'Un chai à barriques pensé pour l\'élevage',
      chai_body: para(
        'À l\'écart des vignes, le chai à barriques accueille nos cuvées pour un élevage patient. Le bois affine les tanins et apporte cette rondeur qui fait la signature du domaine.',
        'Quelques mois à plusieurs années selon les cuvées : le temps du bois ne se presse pas, il accompagne le vin jusqu\'à sa pleine expression.',
      ),
      chai_caption: 'Photo — le chai à barriques',
